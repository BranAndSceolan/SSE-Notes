<template>
  ...
  E-mail: max@muster.de<br>
    ...
    <p>
  Register entry:<br>
  Entry in the register court: Musterstadt<br>
  Registration number: 12345
    </p>
    <p>
  Sales tax ID:<br>
  Sales tax identification number according to §27a Sales Tax Act: Musterustid.<br>
    </p>
    <p>
  Business ID:<br>
  Musterwirtschaftsid
  ...
  Musterstadt supervisory authority
    </p>
    <p>
  Disclaimer:
    <br><br>
  ...
  We point out that data transmission over the Internet (eg communication by e-mail) has security gaps. A complete protection of data against access by third parties is not possible.
  The use of contact data published within the framework of the imprint obligation by third parties for the purpose of sending unsolicited advertising and information materials is hereby expressly prohibited. The operators of the pages expressly reserve the right to take legal action in the event of the unsolicited sending of advertising information, such as spam mails.
      <br><br>
  Imprint from the imprint generator of the law firm Hasselbach, lawyers for labor law and family law
      </p>
  </div>
<div class="notice">
  <h1>Impressum</h1><br>
